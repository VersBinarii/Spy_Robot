...
*				: 2.10  ( 2005-06-06 )										*
*				:		vc25	 bit delete (vcr2 register)					*
*				:		inv17	 bit delete (invc1 register)				*
*				:		lsyn_u0smr	 bit delete (u0smr register)			*
*				:		lsyn_u1smr	 bit delete (u1smr register)			*
*				:		lsyn_u2smr	 bit delete (u2smr register)			*
*																			*
*****************************************************************************/
/*
  note:
